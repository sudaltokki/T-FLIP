class Configs_tsne(object):
    src1_data = 'oulu'
    src1_train_num_frames = 2
    src2_data = 'casia'
    src2_train_num_frames = 2
    src3_data = 'msu'
    src3_train_num_frames = 2
    src4_data = 'replay'
    src4_train_num_frames = 2
    weight = 1
    gamma = 0.3
    beta = 0.5
...
class DefaultConfigs_C(object):
    ...
    tgt_data = 'casia'
    tgt_test_num_frames = 2
    weight = 0.01  # You may use 0.01 or 0.03
    gamma = 0.3
    beta = 0.5
