...
class FASDatasetSSLCLIP(Dataset):
  ...
  def __getitem__(self, item):
    if self.train:
      ...
      if img is None:
        raise FileNotFoundError(f"Error: Unable to read image at path: {img_path}")
...
def get_dataset_ssl_clip(args, src1_data, src1_train_num_frames, src2_data,
  ...
  print('Source Data: ', src1_data)
  src1_train_data_fake = sample_frames(
      args, flag=0, num_frames=src1_train_num_frames, dataset_name=src1_data)
  src1_train_data_real = sample_frames(
      args, flag=1, num_frames=src1_train_num_frames, dataset_name=src1_data)
  print('Source Data: ', src2_data)
  src2_train_data_fake = sample_frames(
      args, flag=0, num_frames=src2_train_num_frames, dataset_name=src2_data)
  src2_train_data_real = sample_frames(
      args, flag=1, num_frames=src2_train_num_frames, dataset_name=src2_data)
  print('Source Data: ', src3_data)
  src3_train_data_fake = sample_frames(
      args, flag=0, num_frames=src3_train_num_frames, dataset_name=src3_data)
  src3_train_data_real = sample_frames(
      args, flag=1, num_frames=src3_train_num_frames, dataset_name=src3_data)
  print('Source Data: ', src4_data)
  src4_train_data_fake = sample_frames(
      args, flag=0, num_frames=src4_train_num_frames, dataset_name=src4_data)
  src4_train_data_real = sample_frames(
      args, flag=1, num_frames=src4_train_num_frames, dataset_name=src4_data)
  print('Source Data: ', src5_data)
  src5_train_data_fake = sample_frames(
      args, flag=2, num_frames=src5_train_num_frames, dataset_name=src5_data)
  src5_train_data_real = sample_frames(
      args, flag=3, num_frames=src5_train_num_frames, dataset_name=src5_data)
  print('Load Target Data')
  print('Target Data: ', tgt_data)
  tgt_test_data = sample_frames(
      args, flag=4, num_frames=tgt_test_num_frames, dataset_name=tgt_data)

  batch_size = args.batch_size # for mcio
